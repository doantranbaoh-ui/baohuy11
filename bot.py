...
OWNER_ID = 5736655322      # ID admin chính
PRICE_RANDOM = 2000
...
def handle_photo(msg):
    try:
        ...
        # thông báo admin
        try: bot.send_message(OWNER_ID, f"Bill #{bill_id} từ {uid}")
